...
public class AddProductActivity extends AppCompatActivity {
    ...
    private void addControls(){
        ...
        managerProductService = new ManagerProductService(this);
    }
    ...
    private void saveProduct() {
        ...
        try {
            ...
            int soLuongTK = Integer.parseInt(soLuong);
            ...
            RequestBody stockQuantity = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(soLuongTK));
            ...
            if (isEdit) {
                ...
                managerProductService.updateProduct(id, name, price, imagePart, description, categoryId, stockQuantity);
            } else {
                // Chế độ THÊM
                managerProductService.addProduct(name, price, imagePart, description, categoryId, stockQuantity);
            }
